...
export const SEARCH_SYNONYMS: Record<string, string[]> = {
  ...
  'сантехнік': ['прораб', 'будівельник', 'ремонт', 'майстер', 'монтаж', 'труби', 'каналізація', 'водопровід', 'опалення', 'спеціаліст', 'фахівець'],
  'електрик': ['прораб', 'будівельник', 'електромонтаж', 'проводка', 'ремонт', 'освітлення', 'майстер', 'спеціаліст', 'фахівець'],
  'прораб': ['будівельник', 'ремонт', 'будівництво', 'майстер', 'сантехнік', 'електрик', 'оздоблення', 'спеціаліст', 'відновлення'],
  'будівельник': ['прораб', 'ремонт', 'будівництво', 'майстер', 'сантехнік', 'електрик', 'цегла', 'бетон', 'спеціаліст'],
  'оздоблення': ['ремонт', 'прораб', 'майстер', 'будівництво', 'шпалери', 'фарба', 'плитка'],
  ...
  // Побутові послуги
  'прибирання': ['клінінг', 'чистка', 'прибирач', 'чисто', 'порядок', 'миття', 'прибиральниця'],
  'клінінг': ['прибирання', 'чистка', 'миття', 'прибиральниця', 'порядок'],
  'кур\'єр': ['доставка', 'перевезення', 'логістика', 'транспорт', 'посилка'],
  'доставка': ['кур\'єр', 'перевезення', 'логістика', 'транспорт', 'посилка'],
  'вантажники': ['переїзд', 'вантаж', 'перевезення', 'транспорт', 'піднімання', 'переноска'],
  'переїзд': ['вантажники', 'перевезення', 'транспорт', 'пакування', 'піднімання'],
  
  // Тварини
  'ветеринар': ['ветклініка', 'тварини', 'лікування', 'собаки', 'коти', 'здоров\'я тварин', 'вет'],
  'грумер': ['стрижка тварин', 'собаки', 'коти', 'догляд', 'тварини', 'грумінг'],
  
  // Фото/відео
  'фотограф': ['фотозйомка', 'фото', 'весілля', 'портрет', 'студія', 'камера', 'фотосесія'],
  'відеограф': ['відео', 'відеозйомка', 'монтаж', 'весілля', 'зйомка', 'відеооператор'],
  
  // Їжа
  'кухар': ['кейтеринг', 'приготування', 'їжа', 'банкет', 'готування', 'меню', 'шеф'],
  'кондитер': ['торти', 'випічка', 'солодощі', 'десерт', 'кейк', 'тістечка'],
  
  // Додаткові загальні терміни
  'послуга': ['сервіс', 'майстер', 'виконавець', 'спеціаліст', 'робота'],
  'майстер': ['спеціаліст', 'виконавець', 'професіонал', 'фахівець', 'експерт'],
  'ремонт': ['відновлення', 'налагодження', 'полагодження', 'майстер', 'сервіс'],
}
