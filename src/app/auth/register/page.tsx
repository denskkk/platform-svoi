        ...
        <div className="text-center mt-12 space-y-4">
          ...
          <div className="max-w-2xl mx-auto bg-blue-50 border border-blue-200 rounded-xl p-6">
            ...
            <p className="text-sm text-blue-800">
              Почніть зі <strong>Звичайного</strong> акаунту безкоштовно, 
              а потім завжди зможете покращити до <strong>Розширеного</strong> або <strong>Бізнес</strong> 
              для отримання додаткових можливостей!
            </p>
          </div>
        </div>
      </div>
